...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.modal = function (created) {
  for (let i = 0; i < this.length; i++) {
    ...
    const close = document.querySelectorAll(`${target} [data-close]`);
    close.forEach(elem => {
...
Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('#trigger').click(() => Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('#trigger').createModal({
  text: {
    title: 'Modal title',
    body: 'Lorem ipsum, dolor sit amet consectetur adipisicing elit. Assumenda nam dolorem esse minima quam doloribus est. Sed recusandae mollitia asperiores temporibus distinctio.'
  },
  btns: {
    count: 3,
    settings: [['Close', ['btn-danger', 'mr-10'], true], ['Save changes', ['btn-success', 'mr-10'], false, () => {
      alert('Data save');
    }], ['Another buttob', ['btn-warning', 'ml-10'], false, () => {
      alert('Yeah save');
    }]]
  }
}));
